...
import type { BookEntry } from "./sttTypes"
...
export const SPOKEN_NUMBERS: { [key: string]: number } = {
    ...
    "fifty one": 51, "fifty two": 52, "fifty three": 53, sixty: 60, seventy: 70,
    eighty: 80, ninety: 90, hundred: 100,
    "one hundred": 100, "one hundred and fifty": 150, "one hundred fifty": 150,
}
